...
int main()
{
    ...
    int t2 = (c2/(double)CLOCKS_PER_SEC)*1000000;
     cout << "Time to sort the almost sorted list:" << t2 << " microseconds" << endl;
    ...
    int t3 = (c3/(double)CLOCKS_PER_SEC)*1000000;
     cout << "Time to sort the duplicated list:" << t3 << " microseconds" << endl;
    cout << endl;
    inFile.close();
    ...
    c5 = clock();
    int l = sizeof(arr5)/sizeof(arr5[0]);
    quickSort(arr4, 0, l-1);
    cout << "The number of comparisons:" << count << endl;
    c5 = clock() - c5;
    int t5 = (c5/(double)CLOCKS_PER_SEC)*1000000;
     cout << "Time to sort William's  list:" << t5 << " microseconds" << endl;
    inFile.close();
